...
# calculate.R
#
# Coordinates duplex metric computation for single or multiple rinfo files.
#
# Provides `process_data()`, which connects CLI argument parsing (cli.R)
# with metric computation (calc_duplex_metrics.R), handles input modes,
# and writes long-format CSV output.
#
